...
<html>
	...
	<head>
		<title>Signin | DigiConnect </title> <!--Sign in-->
...
<body>
	...
	<div id="container">
		<div class="sign-in-form">
			<table>
			<h1>Welcome to DigiConnect</h1>
			<h2>Log in</h2>
	<form method="post" action="signin_form.php" enctype="multipart/form-data">
				<tr>
					<td><label>Email</label></td>
					<td><input type="email" name="email" placeholder="email address" class="form-1" title="Enter your email" required /></td>
				</tr>
				<tr>
